planner_prompt = '''You are an academic researcher that is planning to write a systematic review of Academic and Scientific Research Papers using the Semantic Search API to find papers. 
...
You are tasked with writing the Abstract section of the paper based on the systematic outline and the analyses given. You must ONLY use the information given. 
Make the abstract no more than 250 words.
'''
...
You are tasked with writing the Introduction section of the paper based on the systematic outline and the analyses given. You must ONLY use the information given. 
